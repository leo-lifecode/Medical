...
<div class="content">
    ...
    <div class="card">
        <form action="/dashboard/patient/{{$patient->id}}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Age</label>
                            <input type="text" name="age" value="{{ old('age', $patient->age ?? '') }}" class="form-control" />
                            @error('age')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="treatment" value="{{ old('treatment', $patient->treatment ?? '') }}" class="form-control" />
                            @error('treatment')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Room</label>
                            <input type="text" name="room" value="{{ old('room', $patient->room ?? '') }}" class="form-control" />
                            @error('room')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input id="notes" type="hidden" name="notes" value="{{ old('notes',$patient->notes ?? '') }}">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <img src="{{ asset('storage/' . $patient->image) }}" id="file-preview">
